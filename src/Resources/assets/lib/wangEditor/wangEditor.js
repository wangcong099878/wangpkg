    ...
    _createPanel: function _createPanel(text, link) {
        ...
        var panel = new Panel(this, {
            ...
            // tab 复制链接的标题
            {
                title: '复制',
                // 模板
                tpl: '<div>\n                            <input id="' + inputTextIdCopy + '" type="text" class="block" value="" placeholder="\u63CF\u8FF0\u6587\u5B57"/></td>\n                            <input id="' + inputLinkIdCopy + '" type="text" class="block" value="" placeholder="\u590D\u5236\u7684\u5185\u5BB9"/></td>\n                            <div class="w-e-button-container">\n                                <button id="' + btnOkIdCopy + '" class="right">\u63D2\u5165</button>\n                            </div>\n                        </div>',
                // 事件绑定
                events: [
                // 插入链接
                {
            ...
            // tab APP外打开跳转
            {
                ...
                title: '外链',
                // 模板
                tpl: '<div>\n                            <input id="' + inputTextIdOpen + '" type="text" class="block" value="" placeholder="\u63CF\u8FF0\u6587\u5B57"/></td>\n                            <input id="' + inputLinkIdOpen + '" type="text" class="block" value="" placeholder="\u6253\u5F00\u94FE\u63A5\u5730\u5740\uFF1Ahttps://..."/></td>\n                            <div class="w-e-button-container">\n                                <button id="' + btnOkIdOpen + '" class="right">\u63D2\u5165</button>\n                            </div>\n                        </div>',
                // 事件绑定
                events: [
                // 插入链接
                {
            ...
            // tab APP内跳转
            {
                title: '内部跳转',
                // 模板
                tpl: '<div>\n                            <input id="' + inputTextIdApp + '" type="text" class="block" value="' + text + '" placeholder="\u63CF\u8FF0\u6587\u5B57"/></td>\n                            <input id="' + inputLinkIdApp + '" type="text" class="block" value="' + link + '" placeholder="\u6587\u7AE0id a:1 \u4EFB\u52A1id t:1"/></td>\n                            <div class="w-e-button-container">\n                                <button id="' + btnOkIdApp + '" class="right">\u63D2\u5165</button>\n                            </div>\n                        </div>',
                // 事件绑定
                events: [
                // 插入链接
                {
    ...
    _createPanel: function _createPanel(text, link) {
        ...
        var panel = new Panel(this, {
            ...
            // tab APP内跳转
            {
                title: '内链',
                // 模板
                tpl: '<div>\n                            <input id="' + inputTextIdApp + '" type="text" class="block" value="' + text + '" placeholder="\u63CF\u8FF0\u6587\u5B57"/></td>\n                            <input id="' + inputLinkIdApp + '" type="text" class="block" value="' + link + '" placeholder="\u6587\u7AE0id"/></td>\n                            <div class="w-e-button-container">\n                                <button id="' + btnOkIdApp + '" class="right">\u63D2\u5165</button>\n                            </div>\n                        </div>',
                // 事件绑定
                events: [
                // 插入链接
                {
    ...
    uploadImg: function uploadImg(files) {
        ...
        arrForEach(files, function (file) {
            ...
            if (maxSize < size) {
                ...
                //`【${name}】大于 ${maxSizeM}M`
                //
                errInfo.push('\u8BF7\u4E0A\u4F20\u5C0F\u4E8E' + maxSizeM + 'M\u7684\u56FE\u7247');
                return;
            }
