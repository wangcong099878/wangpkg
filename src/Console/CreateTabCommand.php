...
class CreateTabCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'wangpkg:createTab {classname?} {textname?}';
    ...
    public function handle()
    {
        ...
        $stub = $this->files->get(__DIR__ . "/stubs/grid/grid.stub");
